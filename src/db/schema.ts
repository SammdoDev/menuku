...
export const analyticsEventType = pgEnum("analytics_event_type", [
  "page_view", "product_view", "category_click", "link_click", "whatsapp_click", "instagram_click", "maps_click", "share_click",
]);
...
export const categories = pgTable("categories", {
  ...
  isActive: boolean("is_active").notNull().default(true),
  ...timestamps,
}, (table) => [unique("categories_tenant_slug_unique").on(table.tenantId, table.slug), index("categories_tenant_sort_idx").on(table.tenantId, table.sortOrder)]);
...
export const analyticsEvents = pgTable("analytics_events", {
  ...
  index("analytics_events_tenant_event_created_idx").on(table.tenantId, table.eventType, table.createdAt),
  index("analytics_events_tenant_product_created_idx").on(table.tenantId, table.productId, table.createdAt),
]);
